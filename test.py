...
for i, data in progress_bar:
    ...
    # Save image files
    vutils.save_image(fake_image_A.detach(), os.path.join(args.outf,args.dataset,'A',str(i + 1:04d)+".png", normalize=True)
    vutils.save_image(fake_image_B.detach(), os.path.join(args.outf,args.dataset,'B',str(i + 1:04d)+".png", normalize=True)
